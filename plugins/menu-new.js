...
cmd({
    ...
    try {
        ...
        const botName      = config.BOT_NAME   || '𝐐𝐚𝐝ᥱ֟፝𝐞𝐫-𝐊𝐃';
        const ownerName    = config.OWNER_NAME || 'Qadeer-TechX';
        ...
        const imageUrl = config.MENU_IMAGE_URL || 'https://eliteprotech-url.zone.id/1778606368589obfzir.jpg';
